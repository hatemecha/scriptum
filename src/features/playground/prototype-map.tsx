...
const sections: PrototypeSection[] = [
  ...
  {
    description:
      "Flujo principal: elegir proyecto, escribir en lienzo, escenas, exportar. IDs demo alineados con preview-data.",
    title: "Editor y escritura",
    links: [
      { href: routes.projectEditor("the-silent-editor"), label: "The Silent Editor" },
      { href: routes.projectEditor("manana-sin-mapa"), label: "Mañana sin mapa" },
      { href: routes.projectEditor("last-call"), label: "Last Call" },
      {
        href: `${routes.projectEditor("the-silent-editor")}?state=empty`,
        hint: "?state=empty",
        label: "Editor vacío (sin bloques)",
      },
      {
        href: `${routes.projectEditor("the-silent-editor")}?state=loading`,
        hint: "?state=loading",
        label: "Editor cargando",
      },
      {
        href: `${routes.projectEditor("the-silent-editor")}?state=error`,
        hint: "?state=error",
        label: "Editor error",
      },
      {
        href: `${routes.projectEditor("the-silent-editor")}?state=offline`,
        hint: "?state=offline",
        label: "Editor sin conexión",
      },
      {
        href: `${routes.projectEditor("the-silent-editor")}?state=saving`,
        hint: "?state=saving",
        label: "Editor guardando",
      },
      {
        href: `${routes.projectEditor("the-silent-editor")}?state=synced`,
        hint: "?state=synced",
        label: "Editor sincronizado",
      },
      {
        href: `${routes.projectEditor("the-silent-editor")}?export=ready`,
        hint: "?export=ready",
        label: "Export modal abierto (listo)",
      },
      {
        href: `${routes.projectEditor("the-silent-editor")}?export=exporting`,
        hint: "?export=exporting",
        label: "Export en progreso",
      },
      {
        href: `${routes.projectEditor("the-silent-editor")}?export=success`,
        hint: "?export=success",
        label: "Export exitoso",
      },
      {
        href: `${routes.projectEditor("the-silent-editor")}?export=error`,
        hint: "?export=error",
        label: "Export error",
      },
      {
